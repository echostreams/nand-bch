...
#ifndef dbg
#define dbg(_fmt, ...)     do { printf(_fmt, __VA_ARGS__); } while (0)
#endif
...
char* gf_poly_str(struct gf_poly* poly)
{
	return "";
}
...
{
	/* lifted from http://www-graphics.stanford.edu/~seander/bithacks.html*/
	x ^= x >> 1;
	x ^= x >> 2;
